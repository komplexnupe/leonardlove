...
return (
  ...
  <ul className="nav">
    <li><a href="#About" active><i class="fas fa-user-circle" style={{fontSize: 76}}></i><br/> About Me</a></li>
    ...
    <li style={{marginLeft: 50}}><a href="#projects" hover><i class="fas fa-laptop-code" style={{fontSize: 76}}></i><br/> My Work</a></li>
  </ul>
